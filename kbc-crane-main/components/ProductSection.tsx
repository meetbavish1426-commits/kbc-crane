    ...
    <section className="mt-16">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-x-6 gap-y-8">
        {products.map((item) => (
          ...
          >
            <div className="w-[160px] h-[130px] mx-auto border border-[#5b403f]/60 rounded-xl bg-white p-[6px] overflow-hidden shadow-sm transition-all duration-400 group-hover:shadow-xl group-hover:border-[#c9121f]/40 group-hover:-translate-y-2 relative">
              ...
              {/* Hover overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-[#c9121f]/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-400 rounded-xl flex items-end justify-center pb-3">

  ...
  return (
    <main className="bg-[#fff6f4] text-[#2b1f1f] font-sans overflow-hidden">
      <section className="relative min-h-130 sm:min-h-155 lg:min-h-180 overflow-hidden bg-black">
        ...
        {/* <div className="absolute inset-0 bg-linear-to-r from-black/50 via-black/20 to-black/20" /> */}
        ...
        <div className="relative z-10 max-w-295 mx-auto px-5 sm:px-6 lg:px-8 min-h-130 sm:min-h-155 lg:min-h-180 flex items-center">
          <div className="max-w-180 pl-5 sm:pl-7">
            ...
            <p className="about-writing text-white/90 text-[14px] sm:text-[16px] md:text-[18px] leading-6.5 sm:leading-7.5 max-w-160">
    ...
    <div>
      ...
      <div className="w-full h-px bg-[#e3c7c1] mb-7" />
      ...
      <div ref={statsRef} className="flex flex-wrap gap-6">
        <div className="group w-37.5 h-23.75 border-2 border-[#c40018] bg-white flex flex-col justify-center px-6 transition-all duration-500 hover:bg-[#c40018] hover:-translate-y-2 hover:shadow-2xl">
    ...
    <div className="group relative">
      ...
      <div className="relative overflow-hidden rounded-[26px] border border-[#d9a9a1] bg-white p-3 shadow-xl">
        ...
        {/* TOP CORNER DESIGN */}
        <div className="absolute top-0 left-0 w-24 h-24 border-t-[6px] border-l-[6px] border-[#c40018] rounded-tl-3xl z-20"></div>

        {/* BOTTOM CORNER DESIGN */}
        <div className="absolute bottom-0 right-0 w-24 h-24 border-b-[6px] border-r-[6px] border-[#c40018] rounded-br-3xl z-20"></div>
        ...
        <div className="max-w-295 mx-auto px-7">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-6 mb-6">
            ...
            <div className="bg-[#3a2420] text-white min-h-57.5 p-9 border-l-[5px] border-[#c40018]">
              ...
              <p className="text-[13px] leading-5.5 text-white/80">To lead the global heavy machinery service sector by setting new benchmarks in hydraulic efficiency and digital fleet management.</p>
            </div>
          </div>
...
<section className="bg-[#fff6f4] pt-9.5 pb-16.25 overflow-hidden">
  <div className="max-w-295 mx-auto px-5 md:px-7">
    <h2 className="text-center text-[32px] font-extrabold mb-11">
      Our Journey
    </h2>

    <div className="relative max-w-225 mx-auto">
      <div className="absolute left-5 md:left-1/2 top-0 bottom-0 w-1 bg-[#ffd7d2] md:-translate-x-1/2" />
      ...
      {[
        ...
        >
          ...
          <span className="absolute left-5 md:left-1/2 top-4.5 w-4 h-4 bg-[#c40018] -translate-x-1/2 rotate-45 shadow-md" />
